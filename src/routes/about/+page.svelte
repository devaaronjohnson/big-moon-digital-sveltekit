...
<main class="relative overflow-hidden">
	<header class="relative bg-darkBackground pt-32 pb-10 lg:pt-44 lg:pb-20">
		...
		<div class="container_lg relative px-5 2xl:px-0">
			...
			<!-- <div class="flex items-center justify-center">
				<a
					href="/"
					class="rounded-full border border-lightBlue bg-lightBlue px-8 py-3 font-karla text-base font-normal text-white transition-all duration-200 hover:border-darkBlue hover:bg-darkBlue"
					>Book a Meeting</a
				>
			</div> -->
		...
		<div class="container_xl px-5 2xl:px-0">
			<div class="flex flex-col items-center gap-10 lg:flex-row lg:gap-32">
				<div class="w-full lg:w-1/2">
					<h2
						class="mb-5 font-rubik text-4xl leading-[1.1] font-normal text-balance lg:text-5xl"
					>
	...
	<section class="relative bg-[#f3f3f3] py-10 lg:py-20">
		...
		<div class="container_xl relative px-5 2xl:px-0">
			<h2 class="mb-20 text-center font-rubik text-4xl font-normal lg:text-5xl">
				Services We Offer
			</h2>
			<div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
				<div class="rounded-2xl bg-white p-8 shadow-lg lg:p-16">
					<h3 class="mb-5 font-rubik text-3xl font-medium text-lightBlue">
						1. UI/UX & Web Design
					</h3>
					<p class="mb-5 font-karla text-lg font-light">
				...
				<div class="rounded-2xl bg-white p-8 shadow-lg lg:p-16">
					<h3 class="mb-5 font-rubik text-3xl font-medium text-lightBlue">2. Web Development</h3>
					<p class="mb-5 font-karla text-lg font-light">
						Interfaces that delight users & drive conversions. From wireframes to prototypes, we
						design with outcomes
					</p>
	...
	<section class="relative bg-darkBackground py-10 lg:py-20">
		<div class="container_xl px-5 2xl:px-0">
			<h2 class="mb-20 text-center font-rubik text-4xl font-normal text-white lg:text-5xl">
				Some of Our Work
			</h2>
